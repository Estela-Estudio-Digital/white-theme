...
<body <?php body_class(); ?>>
        ...
        <nav class="py-3 container navbar">
            ...
            <div class="mr-auto">
                <a href="<?php echo bloginfo('url');?>" >
                    <!-- <img src="<?php bloginfo('template_directory');?>/assets/img/logo.jpg" alt="LadiDada" style="height:35px"> -->
                    <span><i class="far fa-kiss-wink-heart"></i> | LariDada</span>
                </a>
            </div>
    ...
    <nav class='container-fluid bk-primary-nav bg-light d-none'>
        <div class="container">
