...
if ($test_url !== false) {
	...
	{
		wp_deregister_script('jquery');
		wp_register_script('jquery', get_bloginfo('template_url') . '/assets/js/lib/jquery-3.4.1.min.js');
		wp_enqueue_script('jquery');
	}
...
if ( ! function_exists('bk_enqueues') ) {
	...
	/*
   	...
   	------------------------------------------------------------------
   	*/
		wp_register_script('validate-js', get_template_directory_uri() . '/assets/js/lib/jquery.validate.min.js', false, null, true);
		wp_enqueue_script('validate-js');

		wp_register_script('valid-method-js', get_template_directory_uri() . '/assets/js/lib/additional-methods.min.js', false, null, true);
		wp_enqueue_script('valid-method-js');

		wp_register_script('rut-js', get_template_directory_uri() . '/assets/js/lib/rut.js', false, null, true);
		...
		wp_register_script('fullpage-js', get_template_directory_uri() . '/assets/js/lib/fullpage.min.js', false, null, true);
		...
		*/
		...
		wp_register_script('sbjs', get_template_directory_uri() . '/assets/js/lib/sourcebuster.min.js', false, null, true);
